...
const ContactStateCarusal = ({ contactInfoData }) => {
  return (
    <div className="w-full flex justify-center md:justify-start items-center mt-5">
      <div className="hidden md:flex lg:flex w-full flex-col gap-4">
        <div className="flex flex-wrap gap-4 justify-between">
          <div>
            <div key={contactInfoData[0].id} className="flex   items-center">
              ...
              <h2 className="text-sm text-white">{contactInfoData[0].data}</h2>
            </div>
          </div>
          <div>
            <div key={contactInfoData[0].id} className="flex   items-center">
              ...
              <h2 className="text-sm text-white">{contactInfoData[1].data}</h2>
            </div>
          </div>
        </div>
        <div
          key={contactInfoData[2].id}
      ...
      <div className="block md:hidden lg:hidden">
        <Carousel autoplay className="max-w-[325px] flex">
          {contactInfoData.map(item => (
            <div key={item.id} className="flex-col flexCenterImportant">
              ...
              <h2 className="text-xl text-white">{item.data}</h2>
            </div>
          ))}
        </Carousel>
      </div>
